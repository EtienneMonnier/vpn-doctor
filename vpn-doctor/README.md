...
## Current Sprint 2.1 CLI

Early development commands:
...
`connect --dry-run` validates backend command construction without launching a VPN process.
Real connection lifecycle work is still in progress.
